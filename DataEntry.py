...
class DataEntry:
    def __init__(self, dataFrame):
        ...
        # tworzenie ramki do wczytania rozdzielczosci sygnału wej.
        ...
        self.resolution_label = tk.Label(self.resolutionFrame, text="Rozdzielczość sygnału wej.: ")
        self.resolution_label.pack(side = "left")
        self.resolution_entry = tk.Entry(self.resolutionFrame, textvariable = self.resolution)
        self.resolution_entry.pack(side = "right")

        # tworzenie ramki do wczytanie kroku całkowania
        self.step_size = tk.StringVar(value="0.01")
        self.stepFrame = tk.LabelFrame(dataFrame, relief="groove")
        self.stepFrame.pack(side="top", fill="x", pady=2, padx=2)

        self.step_label = tk.Label(self.stepFrame, text="Krok całkowania [s]: ")
        self.step_label.pack(side = "left")
        self.step_entry = tk.Entry(self.stepFrame, textvariable= self.step_size)
        self.step_entry.pack(side = "right")


    def get_impuls(self):
        return Impuls(self.impulsFrame, self.num_a, self.num_b, self.impuls_settings, self.radValues.get(), self.resolution, self.step_size)
    ...
    def show_dataFrame_wsp(self):
        ...
        for i in reversed(range(4)):
            self.label_b.append(tk.Label(self.dataFrame_wsp, text = "b" + str(i).translate(SUB) + "= ", font = "Arial 13"))
        ...
        for i in reversed(range(3)):
            self.label_a.append(tk.Label(self.dataFrame_wsp, text = "a" + str(i).translate(SUB) + "= ", font = "Arial 13"))
    ...
    def show_transferFrame(self):
        ...
        self.label_y = tk.Label(self.transferFrame, text = " Y(s) ", font = "Arial 12")
        self.label_y.grid(column = 0, row = 0)
        self.label_y = tk.Label(self.transferFrame, text = " ———", font = "Arial 12")
        self.label_y.grid(column = 0, row = 1)
        self.label_y = tk.Label(self.transferFrame, text = " X(s) ", font = "Arial 12")
        self.label_y.grid(column = 0, row = 2)

        self.label_equals = tk.Label(self.transferFrame, text = " = ", font = "Arial 12")
        self.label_equals.grid(column = 1, row = 1)

        self.label0 = tk.Label(self.transferFrame, text = self.transfer_text[0], font = "Arial 12")
        self.label0.grid(column = 2, row = 0)
        self.label1 = tk.Label(self.transferFrame, text = self.transfer_text[1], font = "Arial 12")
        self.label1.grid(column = 2, row = 1)
        self.label2 = tk.Label(self.transferFrame, text = self.transfer_text[2], font = "Arial 12")
    ...
    def show_amplitudeFrame(self):
        ...
        self.amplitude_entry = tk.Entry(self.amplitudeFrame,
                                        ...
                                        state = 'disabled')
        self.amplitude_entry.grid(column = 1, row = 0, sticky = "e")
        ...
        self.period_entry = tk.Entry(self.amplitudeFrame,
                                        ...
                                        state = 'disabled')
        self.period_entry.grid(column = 1, row = 1, sticky = "e")
        ...
        self.duration_entry = tk.Entry(self.amplitudeFrame, 
                                        ...
                                        state = 'disabled')
        self.duration_entry.grid(column = 1, row = 2, sticky = "e")
        ...
        self.fulfillment_entry = tk.Entry(self.amplitudeFrame,
                                        ...
                                        state = 'disabled')
        self.fulfillment_entry.grid(column = 1, row = 3, sticky = "e")
        ...
        self.start_entry = tk.Entry(self.amplitudeFrame,
                                        ...
                                        state = 'disabled')
        self.start_entry.grid(column = 1, row = 4, sticky = "e")
